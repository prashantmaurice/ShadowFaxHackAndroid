...
public class MyPhoneReceiver extends BroadcastReceiver {
	...
	public void onReceive(Context context, Intent intent) {
		...
		Log.d(Constants.TAG, "MyPhoneReceiver phoneNumber "+phoneNumber+" : "+extraState);
		Log.d(Constants.TAG, "Intent : "+intent.toString());

		if (MainActivity.updateExternalStorageState() == Constants.MEDIA_MOUNTED&&false) {
			try {
