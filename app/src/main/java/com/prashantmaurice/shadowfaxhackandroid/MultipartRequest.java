...
public class MultipartRequest extends Request<JSONObject> {
    ...
    public MultipartRequest(String url, Response.ErrorListener errorListener,
                            Response.Listener<JSONObject> listener, File file, long fileLength,
    ...
    protected Response<JSONObject> parseNetworkResponse(NetworkResponse response) {
        try {
            System.out.println("Multipart Network Response "+ new String(response.data, "UTF-8"));
            JSONObject obj = new JSONObject();
            obj.put("response", new String(response.data, "UTF-8"));
            return Response.success(obj,getCacheEntry());
        } catch (JSONException e) {
            e.printStackTrace();
            return Response.error(new VolleyError("Fuck this, this should not happen"));
        } catch (UnsupportedEncodingException e) {
            Log.e("ERROR","Response from Node is not parsable");
            e.printStackTrace();
            return Response.error(new VolleyError("Response from Node is not parsable"));
        }
    }
